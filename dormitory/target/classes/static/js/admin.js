(function ($) {
    ...
    $.learunindex = {
        ...
        loadMenu: function () {
            var data = [{ "F_ModuleId": "1", "F_ParentId": "0","F_FullName": "人员管理", "F_Icon": "fa fa-money", "F_UrlAddress": null }
            ,{ "F_ModuleId": "A0", "F_ParentId": "1","F_FullName": "用户管理", "F_Icon": "fa fa-gg", "F_UrlAddress": "/account?page=1" }
            ,{ "F_ModuleId": "A1", "F_ParentId": "1","F_FullName": "黑名单管理", "F_Icon": "fa fa-gg", "F_UrlAddress": "/manager/blackList?page=1" }
            ,{ "F_ModuleId": "A2", "F_ParentId": "1","F_FullName": "访客管理", "F_Icon": "fa fa-gg", "F_UrlAddress": "/manager/visitor?page=1" }
           
            ,{ "F_ModuleId": "2", "F_ParentId": "0","F_FullName": "楼宇与宿舍", "F_Icon": "fa fa-money", "F_UrlAddress":null }
            ,{ "F_ModuleId": "A3", "F_ParentId": "2","F_FullName": "楼宇与宿舍管理", "F_Icon": "fa fa-gg", "F_UrlAddress": "/manager/dormitory?buildingid=1&page=1" }
            ,{ "F_ModuleId": "A4", "F_ParentId": "2","F_FullName": "楼宇与管理员管理", "F_Icon": "fa fa-gg", "F_UrlAddress": "/manager/dormitoryAdmin?page=1" }
            ,{ "F_ModuleId": "3", "F_ParentId": "0","F_FullName": "信息管理", "F_Icon": "fa fa-gg", "F_UrlAddress": null }
            ,{ "F_ModuleId": "A5", "F_ParentId": "3","F_FullName": "学院信息管理", "F_Icon": "fa fa-gg", "F_UrlAddress": "/manager/collage?page=1" }
            ,{ "F_ModuleId": "A6", "F_ParentId": "3","F_FullName": "专业信息管理", "F_Icon": "fa fa-gg", "F_UrlAddress": "/manager/major?page=1" }
            ,{ "F_ModuleId": "A7", "F_ParentId": "3","F_FullName": "班级信息管理", "F_Icon": "fa fa-gg", "F_UrlAddress": "/manager/class?page=1" }
            ,{ "F_ModuleId": "A8", "F_ParentId": "3","F_FullName": "学生信息管理", "F_Icon": "fa fa-gg", "F_UrlAddress": "/manager/student?page=1"}
           /* ,{ "F_ModuleId": "3", "F_ParentId": "0","F_FullName": "", "F_Icon": "fa fa-gg", "F_UrlAddress": null }
            ,{ "F_ModuleId": "A5", "F_ParentId": "3","F_FullName": "系统登录绩效考核", "F_Icon": "fa fa-gg", "F_UrlAddress": "visitor?page=1" }
            ,{ "F_ModuleId": "A6", "F_ParentId": "3","F_FullName": "楼栋进出绩效考核", "F_Icon": "fa fa-gg", "F_UrlAddress": "visitor?page=1" }*/];
            var _html = "";

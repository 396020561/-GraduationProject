(function ($) {
    ...
    $.learunindex = {
        ...
        loadMenu: function () {
            var data = [{ "F_ModuleId": "1", "F_ParentId": "0","F_FullName": "概览信息展示", "F_Icon": "fa fa-money", "F_UrlAddress": null }
            ,{ "F_ModuleId": "A0", "F_ParentId": "1","F_FullName": "通行数据", "F_Icon": "fa fa-gg", "F_UrlAddress": "overview" }
/*            ,{ "F_ModuleId": "A1", "F_ParentId": "1","F_FullName": "异常数据", "F_Icon": "fa fa-gg", "F_UrlAddress": "exception" }
            ,{ "F_ModuleId": "A2", "F_ParentId": "1","F_FullName": "请假数据", "F_Icon": "fa fa-gg", "F_UrlAddress": "leave?page=1" }*/
           
            ,{ "F_ModuleId": "2", "F_ParentId": "0","F_FullName": "请假与销假", "F_Icon": "fa fa-money", "F_UrlAddress":null }
            ,{ "F_ModuleId": "A3", "F_ParentId": "2","F_FullName": "请假记录", "F_Icon": "fa fa-gg", "F_UrlAddress": "leave?page=1" }
            ,{ "F_ModuleId": "A4", "F_ParentId": "2","F_FullName": "申请假条", "F_Icon": "fa fa-gg", "F_UrlAddress": "leave/add" }
            ,{ "F_ModuleId": "3", "F_ParentId": "0","F_FullName": "访客管理", "F_Icon": "fa fa-gg", "F_UrlAddress": null }
            ,{ "F_ModuleId": "A5", "F_ParentId": "3","F_FullName": "录入访客", "F_Icon": "fa fa-gg", "F_UrlAddress": "visitor?page=1" }
            ,{ "F_ModuleId": "4", "F_ParentId": "0","F_FullName": "通行记录查询", "F_Icon": "fa fa-gg", "F_UrlAddress": null }
            ,{ "F_ModuleId": "A6", "F_ParentId": "4","F_FullName": "通行记录", "F_Icon": "fa fa-gg", "F_UrlAddress": "/accAttend" }];
            var _html = "";
